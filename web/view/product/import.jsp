<%-- 
    Document   : import
    Created on : Oct 2, 2021, 12:52:53 PM
    Author     : ASUS
--%>
                    ...
                    <div class="right">
                        <form action="import" method="POST">
                            <table>
                                ...
                                <caption>Import product</caption>
                                <tr>
                                ...
                                <tr>
                                    <td>Quantity import <span style="color: red;">*</span></td>
                                    <td>
                                        <input type="number" name="quantityImport" min="1" required/>
                                    </td>
                                    <td></td>
