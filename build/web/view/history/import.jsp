...
<html>
    <head>
        ...
        <script>
            ...
            function detail(id) {
                window.location.href = "${pageContext.request.contextPath}/history/import/detail?id=" + id;
            }
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="right">
                        ...
                        <script>
                            createPagger('import', 'paggerBottom', ${requestScope.pageIndex-1}, ${requestScope.pageIndex}, ${requestScope.pageIndex+1}, 2, ${requestScope.totalPage});
                        </script> 
                    </div>
                </div>
            </div>
